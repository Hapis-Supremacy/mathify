...
<%
    ...
    long __assetVer;
    try {
        String __rp = application.getRealPath("/assets/app/login.js");
...
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600&family=Fraunces:opsz,wght@9..144,500;9..144,600&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="<%= __assetBase %>/login.css?v=<%= __assetVer %>"/>
</head>
<body>
  <div id="root"></div>
  ...
  <%-- Built React island (frontend/src/pages/login, compiled by Vite). --%>
  <script type="module" src="<%= __assetBase %>/login.js?v=<%= __assetVer %>"></script>
</body>
</html>
