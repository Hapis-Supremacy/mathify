...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  @keyframes drift {
    0%   { transform: translateY(0px)   rotate(0deg);   opacity: .15; }
    50%  { transform: translateY(-32px) rotate(10deg);  opacity: .22; }
    100% { transform: translateY(0px)   rotate(0deg);   opacity: .15; }
  }
  @keyframes slideUp {
